      ...
      <div style={{ marginTop: "20px" }}>
        ...
        >
          <Nav
            variant="tabs"
            className="flex-row"
            style={{ justifyContent: "left", borderColor: "#132B4B" }}
          >
                ...
                style={{
                  ...
                  borderRadius:
                    index === 0
                      ...
                      ? "0 15px 0 0"
                      : "0", // Rounded corners only for the first and last tab
            ...
            <Modal.Body style={{ backgroundColor: "#fff8c9" }}>
              ...
              {showButtons && (
                <div>
                    ...
                    onClick={() => {
                      if (!userFound) {
                        ...
                        if (!slot.occupied) {
                          ...
                          setErrorMessage(
                            "Cannot assign an already occupied slot."
                          );
                        }
                      }
                    }}
                  ...
                  <button
                    className="btn-custom-exit"
                    onClick={() =>
                      handleExitSlot(selectedSlot, userPlateNumber)
                    }
                  >
                    Exit
                  </button>
